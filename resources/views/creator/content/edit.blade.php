                                            ...
                                            <div class="row" id="hideme">
                                                <div class="col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $item->title }}" class="form-control" name="title" id="title" placeholder="Title">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="content_type" id="content_type" class="form-control">
                                                            <option {{ $item->content_type == 'public' ? 'selected' : ' ' }} value="public">Public - Everyone Can See & Download</option>
                                                            <option {{ $item->content_type == 'private' ? 'selected' : ' ' }} value="private">Private - Only You Can See</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6">
                                                ...
                                                <div class="col-md-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{ $item->cost }}" min="0" name="cost" class="form-control" id="cost" placeholder="Price">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="selectgroup selectgroup-pills">
                                                            @foreach($cats as $cat)
                                                                <label class="selectgroup-item">
                                                                    <input type="checkbox" name="categories[]" {{ in_array($cat->id, $catids) ? 'checked' : '' }} value="{{ $cat->id }}" class="selectgroup-input">
